    ...
    public class EnglishDetailsDialog :ComponentDialog
    {
        ...
        {   
            ...
            try{
                ...
                List<County> counties = JsonConvert.DeseriaCounty m = JsonConvert.DeserializeObject<List<_county>>(json);lizeObject<List<County>>(json);
                ...
                if((string) stepContext.Values["preferredLanguage"] == "English"){
                        ...
                        var promptOptions =  new PromptOptions{
                                ...
                                Choices = ChoiceFactory.ToChoices(c),
                        };
